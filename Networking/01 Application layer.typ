...
#figure(
  image("Images/Centralized server.png", width: 50%),
...
#figure(
  image("Images/DNS query.png", width: 70%)  
)
==== DNS caching
...
#figure(
  image("Images/DNS message.png", width: 60%)
)
The fields are:
...
#figure(
  image("Images/File distribution.png", width: 40%)
)
