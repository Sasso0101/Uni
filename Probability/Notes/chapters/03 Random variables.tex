...
\begin{figure}[ht]
    ...
    \caption*{Cumulative distribution function of the marbles exercise}
\end{figure}
\vbox{
    Properties of $F_X$:
    \begin{enumerate}
...
As it can be seen from the graphs, the height of the jump at point $x_0$ represent the probability of the random variable to have value $x_0$.
\begin{definition}
