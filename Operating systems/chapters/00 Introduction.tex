...
An operating system is composed of a kernel, system programs and user programs. The \bold{kernel} is the core of the operating system, has complete control over everything in the system and runs for the whole time the system is turned on. System programs are other programs that are shipped with the operating system.
